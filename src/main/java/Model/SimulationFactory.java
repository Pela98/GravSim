...
public class SimulationFactory {
    ...
    public static void generate1970SolarSystem() {
        ...
        createBasicPhysicsBody(sim, "Sole",
        ...
        // 1. MERCURIO
        createBasicPhysicsBody(sim, "Mercurio",
        ...
        // 2. VENERE
        createBasicPhysicsBody(sim, "Venere",
        ...
        createBasicPhysicsBody(sim, "Terra",
        ...
        // 4. MARTE
        createBasicPhysicsBody(sim, "Marte",
        ...
        // 5. GIOVE
        createBasicPhysicsBody(sim, "Giove",
        ...
        // 6. SATURNO
        createBasicPhysicsBody(sim, "Saturno",
        ...
        // 7. URANO
        createBasicPhysicsBody(sim, "Urano",
        ...
        // 8. NETTUNO
        createBasicPhysicsBody(sim, "Nettuno",
